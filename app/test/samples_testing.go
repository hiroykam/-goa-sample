...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListSamplesBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.SamplesController, userID int) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListSamplesNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.SamplesController, userID int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListSamplesOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.SamplesController, userID int) (http.ResponseWriter, app.SamplesCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
